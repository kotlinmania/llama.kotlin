...
| Area | Why you’d read it | Where to start |
|------|--------------------|----------------|
| Getting oriented | Understand how the two runtimes fit together and what “stackless” really means | [`external/kcoro_arena/docs/components/stackless_runtime/OVERVIEW.md`](../external/kcoro_arena/docs/components/stackless_runtime/OVERVIEW.md) |
...
| Scheduler & tasks | Understand the cooperative event loop and worker threads | `external/kcoro_arena/docs/components/stackless_runtime/SCHEDULER.md` |
| Migration & roadmap | Check what’s next or how to port older code | `external/kcoro/docs/components/roadmap/` (roadmap) and the issue tracker |
