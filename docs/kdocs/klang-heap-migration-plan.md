...
- [ ] Add external/klang to source sets in build.gradle.kts
- [ ] Update imports from `ai.solace.klang.bitwise` to vendored packages
- [ ] Test that existing code compiles with vendored klang
...
- [ ] Delete `src/commonMain/kotlin/ai/solace/klang/`
- [ ] Verify all imports point to `external/klang`
- [ ] Update tests to use vendored klang

## Migration Order

1. **Non-breaking**: Update imports, add vendored klang to build
...
- [ ] All existing tests pass with vendored klang
...
1. Update build.gradle.kts to include external/klang
