...
class Float128 private constructor(
    ...
    private val mantissa: LimbUInt128,
    ...
    companion object {
        ...
        fun zero(sign: Int = 0): Float128 = Float128(sign, 0, LimbUInt128.zero(), true, false, false)
        ...
        fun fromDouble(value: Double): Float128 {
            ...
            val mantissa = LimbUInt128.fromLimbsUnsafe(mant)
        ...
        fun fromDecimalString(decimal: String): Float128 {
            ...
            if (trimmed.equals("nan", ignoreCase = true)) return Float128(0, 0, LimbUInt128.zero(), false, false, true)
            if (trimmed.equals("inf", ignoreCase = true)) return Float128(0, EXP_MAX, LimbUInt128.zero(), false, true, false)
            if (trimmed.equals("-inf", ignoreCase = true)) return Float128(1, EXP_MAX, LimbUInt128.zero(), false, true, false)
        ...
        private data class Parsed(val mantissa: LimbUInt128, val exponent: Int, val isZero: Boolean)
        ...
        private fun decimalToBinary128(value: String): Parsed {
            ...
            for (ch in integerPart) {
                ...
                mantissa = LimbUInt128.fromLimbsUnsafe(buffer)
            }
