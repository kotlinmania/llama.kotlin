# Stackless Runtime Overview (Verified)

_Last reviewed: 2025-10-14_

This version mirrors the current implementation in `external/kcoro_arena/core/src` and the accompanying tests. Any change in behaviour should update this file first.
