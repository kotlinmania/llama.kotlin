...
object NativeHeapTensorStorage {
     ...
     */
    inline fun Buffer.getFloatAt(index: Int): Float = floatPtr[index]

    /**
     * Set float at index (no bounds checking for performance).
     */
    inline fun Buffer.setFloatAt(index: Int, value: Float) {
     ...
     */
    inline fun Buffer.getIntAt(index: Int): Int = intPtr[index]

    /**
     * Set int bits at index (no bounds checking for performance).
     */
    inline fun Buffer.setIntAt(index: Int, value: Int) {
        intPtr[index] = value
    }
     ...
     * Get byte at index.
     */
    inline fun Buffer.getByteAt(index: Int): Byte = ptr[index]

    /**
     * Set byte at index.
     */
    inline fun Buffer.setByteAt(index: Int, value: Byte) {
        ptr[index] = value
    }
}
