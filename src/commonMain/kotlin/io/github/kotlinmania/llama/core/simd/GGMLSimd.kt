...
inline fun GGML_CPU_FP16_TO_FP32(x: Short): Float =
...
inline fun GGML_CPU_FP32_TO_FP16(x: Float): Short =
    _root_ide_package_.io.github.kotlinmania.llama.core.GGML_FP32_TO_FP16(x)

/** Scalar fallback for GGML_CPU_COMPUTE_FP16_TO_FP32. */
inline fun GGML_CPU_COMPUTE_FP16_TO_FP32(x: Short): Float =
    _root_ide_package_.io.github.kotlinmania.llama.core.GGML_FP16_TO_FP32(x)

/** Scalar fallback for GGML_CPU_COMPUTE_FP32_TO_FP16. */
inline fun GGML_CPU_COMPUTE_FP32_TO_FP16(x: Float): Short =
    _root_ide_package_.io.github.kotlinmania.llama.core.GGML_FP32_TO_FP16(x)

// --- Platform-specific FP16 converters (all route to software conversion) ---

/** NEON FP16→FP32. C: neon_compute_fp16_to_fp32 */
fun neonComputeFp16ToFp32(h: UShort): Float = _root_ide_package_.io.github.kotlinmania.llama.core.ggmlFp16ToFp32(h)

/** NEON FP32→FP16. C: neon_compute_fp32_to_fp16 */
fun neonComputeFp32ToFp16(f: Float): UShort = _root_ide_package_.io.github.kotlinmania.llama.core.ggmlFp32ToFp16(f)

/** POWER9 FP16→FP32. C: power_compute_fp16_to_fp32 */
fun powerComputeFp16ToFp32(h: UShort): Float = _root_ide_package_.io.github.kotlinmania.llama.core.ggmlFp16ToFp32(h)

/** POWER9 FP32→FP16. C: power_compute_fp32_to_fp16 */
fun powerComputeFp32ToFp16(f: Float): UShort = _root_ide_package_.io.github.kotlinmania.llama.core.ggmlFp32ToFp16(f)

/** RISC-V FP16→FP32. C: riscv_compute_fp16_to_fp32 */
fun riscvComputeFp16ToFp32(h: UShort): Float = _root_ide_package_.io.github.kotlinmania.llama.core.ggmlFp16ToFp32(h)

/** RISC-V FP32→FP16. C: riscv_compute_fp32_to_fp16 */
fun riscvComputeFp32ToFp16(f: Float): UShort = _root_ide_package_.io.github.kotlinmania.llama.core.ggmlFp32ToFp16(f)

/** Lookup-table FP16→FP32. C: ggml_lookup_fp16_to_fp32 (line 134) */
fun ggmlLookupFp16ToFp32(f: UShort): Float = _root_ide_package_.io.github.kotlinmania.llama.core.ggmlFp16ToFp32(f)
...
fun avxF32cx8Load(data: ShortArray, offset: Int = 0): FloatArray {
    return FloatArray(8) { i -> _root_ide_package_.io.github.kotlinmania.llama.core.ggmlFp16ToFp32(data[offset + i].toUShort()) }
}

/** AVX: store 8 FP32 values as FP16. C: __avx_f32cx8_store (line 645) */
fun avxF32cx8Store(dst: ShortArray, offset: Int, src: FloatArray) {
    for (i in 0 until 8) {
        dst[offset + i] = _root_ide_package_.io.github.kotlinmania.llama.core.ggmlFp32ToFp16(src[i]).toShort()
    }
}
...
fun wasmF16x4Load(data: ShortArray, offset: Int = 0): FloatArray {
    return FloatArray(4) { i -> _root_ide_package_.io.github.kotlinmania.llama.core.ggmlFp16ToFp32(data[offset + i].toUShort()) }
}
...
fun ggmlF32VecZero(): FloatArray = FloatArray(_root_ide_package_.io.github.kotlinmania.llama.core.simd.GGML_F32_EPR)
fun ggmlF32VecSet1(x: Float): FloatArray = FloatArray(_root_ide_package_.io.github.kotlinmania.llama.core.simd.GGML_F32_EPR) { x }

fun ggmlF32VecLoad(data: FloatArray, offset: Int = 0): FloatArray =
    data.copyOfRange(offset, offset + _root_ide_package_.io.github.kotlinmania.llama.core.simd.GGML_F32_EPR)

fun ggmlF32VecStore(dst: FloatArray, offset: Int, src: FloatArray) {
    src.copyInto(dst, offset, 0, _root_ide_package_.io.github.kotlinmania.llama.core.simd.GGML_F32_EPR)
}

fun ggmlF32VecFma(a: FloatArray, b: FloatArray, c: FloatArray): FloatArray {
    return FloatArray(_root_ide_package_.io.github.kotlinmania.llama.core.simd.GGML_F32_EPR) { i -> a[i] + b[i] * c[i] }
}

fun ggmlF32VecAdd(a: FloatArray, b: FloatArray): FloatArray {
    return FloatArray(_root_ide_package_.io.github.kotlinmania.llama.core.simd.GGML_F32_EPR) { i -> a[i] + b[i] }
}
...
internal object GGMLSimd {
    ...
    fun dotF16(
        ...
        while (idx < limit) {
            sum += _root_ide_package_.io.github.kotlinmania.llama.core.halfToFloat(dataA.getShortLe(offsetA)) * _root_ide_package_.io.github.kotlinmania.llama.core.halfToFloat(
                dataB.getShortLe(offsetB)
            )
            sum += _root_ide_package_.io.github.kotlinmania.llama.core.halfToFloat(dataA.getShortLe(offsetA + strideABytes)) * _root_ide_package_.io.github.kotlinmania.llama.core.halfToFloat(
                dataB.getShortLe(offsetB + strideBBytes)
            )
            sum += _root_ide_package_.io.github.kotlinmania.llama.core.halfToFloat(dataA.getShortLe(offsetA + 2 * strideABytes)) * _root_ide_package_.io.github.kotlinmania.llama.core.halfToFloat(
                dataB.getShortLe(offsetB + 2 * strideBBytes)
            )
            sum += _root_ide_package_.io.github.kotlinmania.llama.core.halfToFloat(dataA.getShortLe(offsetA + 3 * strideABytes)) * _root_ide_package_.io.github.kotlinmania.llama.core.halfToFloat(
                dataB.getShortLe(offsetB + 3 * strideBBytes)
            )
            sum += _root_ide_package_.io.github.kotlinmania.llama.core.halfToFloat(dataA.getShortLe(offsetA + 4 * strideABytes)) * _root_ide_package_.io.github.kotlinmania.llama.core.halfToFloat(
                dataB.getShortLe(offsetB + 4 * strideBBytes)
            )
            sum += _root_ide_package_.io.github.kotlinmania.llama.core.halfToFloat(dataA.getShortLe(offsetA + 5 * strideABytes)) * _root_ide_package_.io.github.kotlinmania.llama.core.halfToFloat(
                dataB.getShortLe(offsetB + 5 * strideBBytes)
            )
            sum += _root_ide_package_.io.github.kotlinmania.llama.core.halfToFloat(dataA.getShortLe(offsetA + 6 * strideABytes)) * _root_ide_package_.io.github.kotlinmania.llama.core.halfToFloat(
                dataB.getShortLe(offsetB + 6 * strideBBytes)
            )
            sum += _root_ide_package_.io.github.kotlinmania.llama.core.halfToFloat(dataA.getShortLe(offsetA + 7 * strideABytes)) * _root_ide_package_.io.github.kotlinmania.llama.core.halfToFloat(
