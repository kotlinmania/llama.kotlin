...
private fun readFloatRow2(data: ByteArray, off: Int, n: Int): FloatArray {
    ...
    for (i in 0 until n) {
        row[i] = _root_ide_package_.io.github.kotlinmania.llama.core.readFloat2(data, off + i * 4)
    }
    return row
}
...
private fun writeFloatRow2(data: ByteArray, off: Int, src: FloatArray, srcOff: Int, n: Int) {
    for (i in 0 until n) {
        _root_ide_package_.io.github.kotlinmania.llama.core.writeFloat2(data, off + i * 4, src[srcOff + i])
    }
}
...
private fun binaryOpLocals2(dst: io.github.kotlinmania.llama.core.GGMLTensor): io.github.kotlinmania.llama.core.BinaryOpLocals2 {
    val src0 = dst.src[0]!!
    val src1 = dst.src[1]!!
    return _root_ide_package_.io.github.kotlinmania.llama.core.BinaryOpLocals2(
...
private fun unaryOpLocals2(dst: io.github.kotlinmania.llama.core.GGMLTensor): io.github.kotlinmania.llama.core.UnaryOpLocals2 {
    val src0 = dst.src[0]!!
    return _root_ide_package_.io.github.kotlinmania.llama.core.UnaryOpLocals2(
        ne00 = src0.ne[0], ne01 = src0.ne[1], ne02 = src0.ne[2], ne03 = src0.ne[3],
        nb00 = src0.nb[0].toLong(), nb01 = src0.nb[1].toLong(), nb02 = src0.nb[2].toLong(), nb03 = src0.nb[3].toLong(),
        ne0 = dst.ne[0], ne1 = dst.ne[1], ne2 = dst.ne[2], ne3 = dst.ne[3],
        nb0 = dst.nb[0].toLong(), nb1 = dst.nb[1].toLong(), nb2 = dst.nb[2].toLong(), nb3 = dst.nb[3].toLong()
...
private fun ggml_compute_forward_out_prod_f32(
    ...
    val l = _root_ide_package_.io.github.kotlinmania.llama.core.binaryOpLocals2(dst)
    ...
    if (ith == 0) {
        ...
        for (i in 0 until totalFloats) {
            _root_ide_package_.io.github.kotlinmania.llama.core.writeFloat2(dstData, i * 4, 0f)
        }
    }
    ...
    val blck0 = max(_root_ide_package_.io.github.kotlinmania.llama.core.GGML_VEC_MAD_UNROLL.toLong(), 32L)
    val blck1 = 16L
        ...
        while (bi01 < l.ne01) {
            ...
            while (ir < bir1) {
                ...
                while (i01 < bne01) {
                    ...
                    val s1Val = _root_ide_package_.io.github.kotlinmania.llama.core.readFloat2(src1Data, s1Off)
                    for (i0 in 0 until l.ne0.toInt()) {
                        val s0Val =
                            _root_ide_package_.io.github.kotlinmania.llama.core.readFloat2(src0Data, s0Off + i0 * 4)
                        val cur = _root_ide_package_.io.github.kotlinmania.llama.core.readFloat2(dstData, dOff + i0 * 4)
                        _root_ide_package_.io.github.kotlinmania.llama.core.writeFloat2(
                            dstData,
                            dOff + i0 * 4,
                            cur + s0Val * s1Val
                        )
...
private fun ggml_compute_forward_out_prod_q_f32(
    ...
    require(l.nb00 == _root_ide_package_.io.github.kotlinmania.llama.core.ggmlTypeSize(type).toLong())
    ...
    val wdata = FloatArray((l.ne0.toInt() + _root_ide_package_.io.github.kotlinmania.llama.core.CACHE_LINE_SIZE_F32_2))
    ...
    for (ir in ir0 until ir1) {
        ...
        for (i01 in 0 until l.ne01) {
            ...
            _root_ide_package_.io.github.kotlinmania.llama.core.dequantize_row_2(type, src0Data, s0Off, wdata, 0, l.ne0)
            val s1Val = _root_ide_package_.io.github.kotlinmania.llama.core.readFloat2(src1Data, s1Off)
...
fun ggml_compute_forward_out_prod(
    ...
    when (src0.type) {
        ...
        _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.IQ3_S, _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.IQ2_S -> {
            _root_ide_package_.io.github.kotlinmania.llama.core.ggml_compute_forward_out_prod_q_f32(params, dst)
        }
        ...
        _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32 -> {
            _root_ide_package_.io.github.kotlinmania.llama.core.ggml_compute_forward_out_prod_f32(params, dst)
        }
        else -> {
            error("fatal error")
        }
...
private fun ggml_compute_forward_scale_f32(
    ...
    require(_root_ide_package_.io.github.kotlinmania.llama.core.ggmlIsContiguous(dst))
    ...
    if (b == 0.0f) {
        for (i1 in ir0 until ir1) {
            ...
            val dstOff = (i1 * nb1).toInt()
            val row = _root_ide_package_.io.github.kotlinmania.llama.core.readFloatRow2(dstData, dstOff, nc)
            _root_ide_package_.io.github.kotlinmania.llama.core.ggml_vec_scale_f32_2(nc.toLong(), row, 0, s)
            _root_ide_package_.io.github.kotlinmania.llama.core.writeFloatRow2(dstData, dstOff, row, 0, nc)
        }
    } else {
        for (i1 in ir0 until ir1) {
            val dstOff = (i1 * nb1).toInt()
            val src0Off = (i1 * nb1).toInt()
            val dstRow = _root_ide_package_.io.github.kotlinmania.llama.core.readFloatRow2(dstData, dstOff, nc)
            val src0Row = _root_ide_package_.io.github.kotlinmania.llama.core.readFloatRow2(src0Data, src0Off, nc)
            _root_ide_package_.io.github.kotlinmania.llama.core.ggml_vec_mad1_f32_2(
                nc.toLong(),
                dstRow,
                0,
                src0Row,
            ...
            _root_ide_package_.io.github.kotlinmania.llama.core.writeFloatRow2(dstData, dstOff, dstRow, 0, nc)
        }
    }
}
...
fun ggml_compute_forward_scale(
    ...
    when (src0.type) {
        _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32 -> {
            _root_ide_package_.io.github.kotlinmania.llama.core.ggml_compute_forward_scale_f32(params, dst)
        }
        else -> {
            error("fatal error")
        }
...
private fun ggml_compute_forward_set_f32(
    ...
    require(offset + im0 * nb0 + im1 * nb1 + im2 * nb2 + im3 * nb3 <= _root_ide_package_.io.github.kotlinmania.llama.core.ggmlNbytes(
        dst
    ).toLong())
    ...
    for (ir in ir0 until ir1) {
        ...
        for (ic in 0 until nc) {
            val v = _root_ide_package_.io.github.kotlinmania.llama.core.readFloat2(src1Data, src1Off + ic * 4)
            _root_ide_package_.io.github.kotlinmania.llama.core.writeFloat2(dstData, dstOff + ic * 4, v)
        }
    }
}
...
fun ggml_compute_forward_set(
    ...
    when (src0.type) {
        _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32 -> {
            _root_ide_package_.io.github.kotlinmania.llama.core.ggml_compute_forward_set_f32(params, dst)
        }
        _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I32 -> {
            _root_ide_package_.io.github.kotlinmania.llama.core.ggml_compute_forward_set_i32(params, dst)
        }
        _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F16,
...
fun ggml_compute_forward_cpy(
    ...
    _root_ide_package_.io.github.kotlinmania.llama.core.ggml_compute_forward_dup_2(params, dst)
}
...
private fun ggml_compute_forward_dup_2(
    ...
    if (_root_ide_package_.io.github.kotlinmania.llama.core.ggmlIsContiguous(src0) && _root_ide_package_.io.github.kotlinmania.llama.core.ggmlIsContiguous(
        ...
        val nBytes = _root_ide_package_.io.github.kotlinmania.llama.core.ggmlNbytes(dst).toInt()
    ...
    if (src0.type == _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32 && dst.type == _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32) {
            ...
            for (i2 in 0 until ne2) {
                for (i1 in 0 until ne1) {
                    for (i0 in 0 until ne0) {
                        ...
                        val v = _root_ide_package_.io.github.kotlinmania.llama.core.readFloat2(src0Data, srcOff)
                        _root_ide_package_.io.github.kotlinmania.llama.core.writeFloat2(dstData, dstOff, v)
                    }
                }
            }
        }
    } else if (src0.type == _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F16 && dst.type == _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32) {
        for (i3 in 0 until ne3) {
            for (i2 in 0 until ne2) {
                for (i1 in 0 until ne1) {
                    for (i0 in 0 until ne0) {
                        val srcOff = (i3 * nb03 + i2 * nb02 + i1 * nb01 + i0 * nb00).toInt()
                        val dstOff = (i3 * nb3 + i2 * nb2 + i1 * nb1 + i0 * nb0).toInt()
                        val bits = _root_ide_package_.io.github.kotlinmania.llama.core.readShort2(src0Data, srcOff)
    ...
    } else if (src0.type == _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32 && dst.type == _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F16) {
        for (i3 in 0 until ne3) {
            for (i2 in 0 until ne2) {
                for (i1 in 0 until ne1) {
                    for (i0 in 0 until ne0) {
                        ...
                        val dstOff = (i3 * nb3 + i2 * nb2 + i1 * nb1 + i0 * nb0).toInt()
                        val v = _root_ide_package_.io.github.kotlinmania.llama.core.readFloat2(src0Data, srcOff)
                        val fp16 = _root_ide_package_.io.github.kotlinmania.llama.core.ggmlFp32ToFp16(v)
        ...
        val nBytes = min(_root_ide_package_.io.github.kotlinmania.llama.core.ggmlNbytes(dst).toInt(), min(src0Data.size, dstData.size))
...
private fun ggml_compute_forward_get_rows_q(
    ...
    val nc = l.ne00
    val nr = _root_ide_package_.io.github.kotlinmania.llama.core.ggmlNelements(src1)
    ...
    require(l.nb00 == _root_ide_package_.io.github.kotlinmania.llama.core.ggmlTypeSize(type).toLong())
    require(_root_ide_package_.io.github.kotlinmania.llama.core.ggmlNrows(dst) == nr)
    ...
    for (i in ir0 until ir1) {
        ...
        val i01 = _root_ide_package_.io.github.kotlinmania.llama.core.readInt2(src1Data, i01Off).toLong()
        ...
        _root_ide_package_.io.github.kotlinmania.llama.core.dequantize_row_2(type, src0Data, src0Off, wdata, 0, nc)
        _root_ide_package_.io.github.kotlinmania.llama.core.writeFloatRow2(dstData, dstOff, wdata, 0, nc.toInt())
    }
}
...
private fun ggml_compute_forward_get_rows_f16(
    ...
    for (i in ir0 until ir1) {
        ...
        for (j in 0 until nc.toInt()) {
            val bits = _root_ide_package_.io.github.kotlinmania.llama.core.readShort2(src0Data, src0Off + j * 2)
            val v = _root_ide_package_.io.github.kotlinmania.llama.core.ggmlFp16ToFp32(bits.toUShort())
            _root_ide_package_.io.github.kotlinmania.llama.core.writeFloat2(dstData, dstOff + j * 4, v)
        }
    }
}
    ...
    for (i in ir0 until ir1) {
        ...
        for (j in 0 until nc.toInt()) {
            ...
            val v = _root_ide_package_.io.github.kotlinmania.llama.core.bf16ToF32(
                _root_ide_package_.io.github.kotlinmania.llama.core.GGMLBF16(bits.toUShort())
            )
            _root_ide_package_.io.github.kotlinmania.llama.core.writeFloat2(dstData, dstOff + j * 4, v)
        }
    }
...
fun ggml_compute_forward_get_rows(
    ...
    when (src0.type) {
        ...
        _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.IQ4_NL, _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.IQ4_XS,
        _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.IQ3_S, _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.IQ2_S -> {
            _root_ide_package_.io.github.kotlinmania.llama.core.ggml_compute_forward_get_rows_q(params, dst)
        }
        _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F16 -> {
            _root_ide_package_.io.github.kotlinmania.llama.core.ggml_compute_forward_get_rows_f16(params, dst)
        }
        _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.BF16 -> {
            _root_ide_package_.io.github.kotlinmania.llama.core.ggml_compute_forward_get_rows_bf16(params, dst)
        }
        _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32, _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I32 -> {
            _root_ide_package_.io.github.kotlinmania.llama.core.ggml_compute_forward_get_rows_f32(params, dst)
        }
        else -> {
            error("fatal error")
        }
    ...
    for (i03 in 0 until l.ne03) {
        for (i02 in 0 until l.ne02) {
            for (i in ir0 until ir1) {
                ...
                val i1 = _root_ide_package_.io.github.kotlinmania.llama.core.readInt2(src1Data, idx1Off).toLong()
                ...
                _root_ide_package_.io.github.kotlinmania.llama.core.quantize_row_2(
                    dst.type,
                    src0Data,
                    src0Off,
                    dstData,
    ...
    for (i03 in 0 until l.ne03) {
        for (i02 in 0 until l.ne02) {
            for (i in ir0 until ir1) {
                ...
                val idx1Off = (i10 * l.nb10 + i11 * l.nb11 + i12 * l.nb12).toInt()
                val i1 = _root_ide_package_.io.github.kotlinmania.llama.core.readLong2(src1Data, idx1Off)
...
fun ggml_compute_forward_set_rows(
    ...
    when (src0.type) {
        _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32 -> {
            when (src1.type) {
                _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I64 -> _root_ide_package_.io.github.kotlinmania.llama.core.ggml_compute_forward_set_rows_f32_i64(
                    params,
                    dst
                )
                _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I32 -> _root_ide_package_.io.github.kotlinmania.llama.core.ggml_compute_forward_set_rows_f32_i32(
                    params,
                    dst
                )
...
private fun ggml_compute_forward_get_rows_back_f32_f16(
    ...
    val nc = src0.ne[0].toInt()
    val nr = _root_ide_package_.io.github.kotlinmania.llama.core.ggmlNelements(src1).toInt()

    require(dst.ne[0].toLong() == nc.toLong())
    require(src0.nb[0].toLong() == 2L) // sizeof(ggml_fp16_t)

    for (i in 0 until nr) {
        val r = _root_ide_package_.io.github.kotlinmania.llama.core.readInt2(src1Data, i * 4)

        for (j in 0 until nc) {
            val bits = _root_ide_package_.io.github.kotlinmania.llama.core.readShort2(
                src0Data,
                (i * src0.nb[1].toInt()) + j * 2
            )
            val v = _root_ide_package_.io.github.kotlinmania.llama.core.ggmlFp16ToFp32(bits.toUShort())
            val dstOff = r * dst.nb[1].toInt() + j * 4
            val cur = _root_ide_package_.io.github.kotlinmania.llama.core.readFloat2(dstData, dstOff)
            _root_ide_package_.io.github.kotlinmania.llama.core.writeFloat2(dstData, dstOff, cur + v)
        }
    }
}
...
private fun ggml_compute_forward_get_rows_back_f32(
    ...
    for (i in 0 until nr) {
        ...
        for (j in 0 until nc) {
            val dVal = _root_ide_package_.io.github.kotlinmania.llama.core.readFloat2(dstData, dstOff + j * 4)
            val sVal = _root_ide_package_.io.github.kotlinmania.llama.core.readFloat2(src0Data, src0Off + j * 4)
            _root_ide_package_.io.github.kotlinmania.llama.core.writeFloat2(dstData, dstOff + j * 4, dVal + sVal)
        }
    }
}
...
fun ggml_compute_forward_get_rows_back(
    ...
    when (src0.type) {
        _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F16 -> {
            _root_ide_package_.io.github.kotlinmania.llama.core.ggml_compute_forward_get_rows_back_f32_f16(params, dst)
        }
        _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32 -> {
            _root_ide_package_.io.github.kotlinmania.llama.core.ggml_compute_forward_get_rows_back_f32(params, dst)
        }
        else -> {
            error("fatal error")
        }
...
private fun ggml_compute_forward_diag_f32(
    ...
    val l = _root_ide_package_.io.github.kotlinmania.llama.core.unaryOpLocals2(dst)
        ...
        for (i2 in 0 until l.ne2.toInt()) {
            for (i1 in 0 until l.ne1.toInt()) {
                ...
                for (i0 in 0 until i1) {
                    _root_ide_package_.io.github.kotlinmania.llama.core.writeFloat2(dstData, dOff + i0 * 4, 0f)
                }
                val sVal = _root_ide_package_.io.github.kotlinmania.llama.core.readFloat2(src0Data, sOff + i1 * 4)
                _root_ide_package_.io.github.kotlinmania.llama.core.writeFloat2(dstData, dOff + i1 * 4, sVal)
...
fun ggml_compute_forward_diag(
    ...
    when (src0.type) {
        _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32 -> {
            _root_ide_package_.io.github.kotlinmania.llama.core.ggml_compute_forward_diag_f32(params, dst)
        }
        else -> {
            error("fatal error")
        }
        ...
        while (j < nr) {
            for (i in nPast until nc) {
                if (i > nPast + j) {
                    ...
                    _root_ide_package_.io.github.kotlinmania.llama.core.writeFloat2(dstData, off, value)
                }
            }
            j += nth
        }
...
fun ggml_compute_forward_diag_mask_inf(
    ...
    when (src0.type) {
        _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32 -> {
            _root_ide_package_.io.github.kotlinmania.llama.core.ggml_compute_forward_diag_mask_f32(
                params,
                dst,
...
fun ggml_compute_forward_diag_mask_zero(
    ...
    when (src0.type) {
        _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32 -> {
            _root_ide_package_.io.github.kotlinmania.llama.core.ggml_compute_forward_diag_mask_f32(params, dst, 0f)
        }
        else -> {
            error("fatal error")
        }
...
private fun ggml_compute_forward_soft_max_f32(
    ...
    val wp = FloatArray((l.ne00 + _root_ide_package_.io.github.kotlinmania.llama.core.CACHE_LINE_SIZE_F32_2).toInt())

    val useF16 = src1 != null && src1.type == _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F16
        ...
        for (i02 in 0 until l.ne02) {
            for (i01 in ith.toLong() until l.ne01 step nth.toLong()) {
                ...
                for (i in 0 until l.ne00.toInt()) {
                    wp[i] = _root_ide_package_.io.github.kotlinmania.llama.core.readFloat2(src0Data, spOff + i * 4)
                }
                // ggml_vec_scale_f32(ne00, wp, scale)
                _root_ide_package_.io.github.kotlinmania.llama.core.ggml_vec_scale_f32_2(l.ne00, wp, 0, scale)
                ...
                if (src1Data != null) {
                    ...
                    if (useF16) {
                        for (i in 0 until l.ne00.toInt()) {
                            ...
                            wp[i] += slope * _root_ide_package_.io.github.kotlinmania.llama.core.ggmlFp16ToFp32(bits.toUShort())
                        }
                    } else {
                        for (i in 0 until l.ne00.toInt()) {
                            wp[i] += slope * _root_ide_package_.io.github.kotlinmania.llama.core.readFloat2(
                                src1Data,
                                maskOff + i * 4
                            )
                        }
                ...
                maxVal = _root_ide_package_.io.github.kotlinmania.llama.core.ggml_vec_max_f32_2(l.ne00, wp, 0)

                // if we have sinks, make a correction as if they were included in the softmax
                if (src2Data != null) {
                    val skVal =
                        _root_ide_package_.io.github.kotlinmania.llama.core.readFloat2(src2Data, i02.toInt() * 4)
                    maxVal = max(maxVal, skVal)
                }

                val dp = FloatArray(l.ne00.toInt())
                var sum = _root_ide_package_.io.github.kotlinmania.llama.core.ggml_vec_soft_max_f32_2(
                    l.ne00,
                    dp,
                    0,
                    wp,
                ...
                _root_ide_package_.io.github.kotlinmania.llama.core.ggml_vec_scale_f32_2(l.ne00, dp, 0, invSum)

                // write dp to dst
                _root_ide_package_.io.github.kotlinmania.llama.core.writeFloatRow2(
                    dstData,
                    dpOff,
                    dp,
                    0,
...
fun ggml_compute_forward_soft_max(
    ...
    when (src0.type) {
        _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32 -> {
            _root_ide_package_.io.github.kotlinmania.llama.core.ggml_compute_forward_soft_max_f32(params, dst)
        }
        else -> {
            error("fatal error")
        }
...
private fun ggml_compute_forward_soft_max_ext_back_f32(
    ...
    require(_root_ide_package_.io.github.kotlinmania.llama.core.ggmlIsContiguous(src0))
    require(_root_ide_package_.io.github.kotlinmania.llama.core.ggmlIsContiguous(src1))
    require(_root_ide_package_.io.github.kotlinmania.llama.core.ggmlIsContiguous(dst))
    require(_root_ide_package_.io.github.kotlinmania.llama.core.ggml_are_same_shape(src0, dst))
    ...
    for (i1 in ir0 until ir1) {
        ...
        val dy = _root_ide_package_.io.github.kotlinmania.llama.core.readFloatRow2(src0Data, dyOff, nc)
        val y = _root_ide_package_.io.github.kotlinmania.llama.core.readFloatRow2(src1Data, yOff, nc)
        val dx = FloatArray(nc)

        // dot_y_dy := dot(y, dy)
        val dotYDy = _root_ide_package_.io.github.kotlinmania.llama.core.ggml_vec_dot_f32_2(nc.toLong(), y, 0, dy, 0)
        // dx := dy
        _root_ide_package_.io.github.kotlinmania.llama.core.ggml_vec_cpy_f32_2(nc.toLong(), dx, 0, dy, 0)
        // dx := dx - dot_y_dy
        _root_ide_package_.io.github.kotlinmania.llama.core.ggml_vec_acc1_f32_2(nc.toLong(), dx, 0, -dotYDy)
        // dx := dx * y
        _root_ide_package_.io.github.kotlinmania.llama.core.ggml_vec_mul_f32_2(nc.toLong(), dx, 0, dx, 0, y, 0)
        // dx := dx * scale
        _root_ide_package_.io.github.kotlinmania.llama.core.ggml_vec_scale_f32_2(nc.toLong(), dx, 0, scale)

        _root_ide_package_.io.github.kotlinmania.llama.core.writeFloatRow2(dstData, dxOff, dx, 0, nc)
    }
}
...
fun ggml_compute_forward_soft_max_ext_back(
    ...
    when (src0.type) {
        _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32 -> {
            _root_ide_package_.io.github.kotlinmania.llama.core.ggml_compute_forward_soft_max_ext_back_f32(params, dst)
        }
        else -> {
            error("fatal error")
        }
...
private fun quantize_row_2(type: io.github.kotlinmania.llama.core.GGMLType, src: ByteArray, srcOff: Int, dst: ByteArray, dstOff: Int, k: Long) {
    ...
    val floats = _root_ide_package_.io.github.kotlinmania.llama.core.readFloatRow2(src, srcOff, k.toInt())
    val tmpDst = ByteArray(_root_ide_package_.io.github.kotlinmania.llama.core.ggmlRowSize(type, k).toInt())
    when (type) {
        ...
        _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32 -> {
            ...
            _root_ide_package_.io.github.kotlinmania.llama.core.writeFloatRow2(dst, dstOff, floats, 0, k.toInt())
            return
        }
