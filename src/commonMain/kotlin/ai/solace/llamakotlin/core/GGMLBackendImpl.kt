...
// ---------------------------------------------------------------------------
// Multi-buffer  (ggml-backend-impl.h lines 83-85, implemented in ggml-backend.cpp lines 637-735)
// ---------------------------------------------------------------------------

/**
 * `ggml_backend_buffer_copy_tensor` — copy src tensor data using the
 * destination buffer's copyTensor hook.
 * C: ggml-backend-impl.h / ggml-backend.cpp line 205.
 */
 ...
 * C: ggml-backend-impl.h / ggml-backend.cpp line 707.
 */
 ...
 * C: ggml-backend-impl.h / ggml-backend.cpp line 723.
 */
 ...
 * C: ggml-backend-impl.h / ggml-backend.cpp line 728.
 */
