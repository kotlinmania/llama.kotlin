 ...
 *
 * Provides thread-local storage for [GGMLComputeParams] to eliminate parameter passing
 ...
 *
 * Uses threadlocal-kotlin (io.github.kotlinmania:threadlocal-kotlin:0.3.1) which provides
 ...
 *
 * @see GGMLComputeParams For the compute parameters stored
