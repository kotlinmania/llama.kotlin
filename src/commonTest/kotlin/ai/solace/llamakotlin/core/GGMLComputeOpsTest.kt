...
class GGMLComputeOpsTest {
    ...
    private fun calculateTensorByteSize(type: io.github.kotlinmania.llama.core.GGMLType, ne: LongArray): ULong {
        ...
        if (type == _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.Q8_0 && elements > 0uL) {
            ...
            return (elements.toLong() / _root_ide_package_.io.github.kotlinmania.llama.core.QK8_0).toULong() * type.byteSize
        }
    ...
    private fun createAndInitTensor(
        ...
        val tensorByteSizeForCheck = if (type == _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.Q8_0) {
            if (actualElementCount % _root_ide_package_.io.github.kotlinmania.llama.core.QK8_0 != 0L) throw IllegalArgumentException("Q8_0 element count must be div by QK8_0")
            (actualElementCount / _root_ide_package_.io.github.kotlinmania.llama.core.QK8_0).toULong() * type.byteSize
        } else {
        ...
        if (fillSequence) {
            ...
            if (type == _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.Q8_0) {
                require(numElementsToFill % _root_ide_package_.io.github.kotlinmania.llama.core.QK8_0 == 0) { "Q8_0 fill sequence requires numElements divisible by QK8_0" }
                val numBlocks = numElementsToFill / _root_ide_package_.io.github.kotlinmania.llama.core.QK8_0
                val f32Block = FloatArray(_root_ide_package_.io.github.kotlinmania.llama.core.QK8_0)
                var elemIdx = 0
                for (blockNum in 0 until numBlocks) {
                    for (i in 0 until _root_ide_package_.io.github.kotlinmania.llama.core.QK8_0) {
                    ...
                    val scaleF16Short = _root_ide_package_.io.github.kotlinmania.llama.core.floatToHalf(scaleF32)
                 ...
                 for (i in 0 until numElementsToFill) {
                    when (type) {
                        _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32 -> testBuffer.setFloatLe(writeOffset, currentValue)
                        _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F16 -> testBuffer.setShortLe(writeOffset,
                            _root_ide_package_.io.github.kotlinmania.llama.core.floatToHalf(currentValue)
                        )
                        _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I32 -> testBuffer.setIntLe(writeOffset, currentValue.toInt())
                        _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I16 -> testBuffer.setShortLe(writeOffset, currentValue.toInt().toShort())
    ...
    fun testComputeAddF32() {
        val context =
            _root_ide_package_.io.github.kotlinmania.llama.core.GGMLContext() // Dummy context, not used by current computeAdd impl beyond graphAllocator
        var currentOffset = 0uL

        // 1D Test
        val dims1D = longArrayOf(5)
        val size1D = calculateTensorByteSize(_root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32, dims1D)
        val src0_1D = createAndInitTensor("src0_1D", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32, dims1D, currentOffset, fillSequence = true, startValue = 1.0f, step = 1.0f)
        currentOffset += size1D
        val src1_1D = createAndInitTensor("src1_1D", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32, dims1D, currentOffset, fillSequence = true, startValue = 10.0f, step = 10.0f)
        currentOffset += size1D
        ...
        val resultAdd1D = runBinaryOp(src0_1D, src1_1D, "add_f32_1d") { dst ->
            _root_ide_package_.io.github.kotlinmania.llama.core.computeAdd(graphAllocator, src0_1D, src1_1D, dst)
        }
        ...
        val size2D = calculateTensorByteSize(_root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32, dims2D)
        val src0_2D = createAndInitTensor("src0_2D", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32, dims2D, currentOffset, fillSequence = true, startValue = 1.0f, step = 0.5f)
        currentOffset += size2D
        val src1_2D = createAndInitTensor("src1_2D", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32, dims2D, currentOffset, fillSequence = true, startValue = 10.0f, step = 2.0f)
        ...
        val resultAdd2D = runBinaryOp(src0_2D, src1_2D, "add_f32_2d") { dst ->
            _root_ide_package_.io.github.kotlinmania.llama.core.computeAdd(graphAllocator, src0_2D, src1_2D, dst)
        }
    ...
    fun testComputeAddF16() {
        ...
        var currentOffset = 0uL
        val dims1D = longArrayOf(5)
        val size1D = calculateTensorByteSize(_root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F16, dims1D)

        val src0Vals = floatArrayOf(1.0f, 2.5f, -3.0f, 0.1f, 100.0f)
        val src1Vals = floatArrayOf(0.5f, -1.5f, 12.5f, 0.05f, -20.0f)

        val src0_1D = createAndInitTensor("src0_F16", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F16, dims1D, currentOffset)
        currentOffset += size1D
        val src1_1D = createAndInitTensor("src1_F16", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F16, dims1D, currentOffset)
        ...
        for (i in 0 until dims1D[0].toInt()) {
            ...
            val expectedF16AsF32 = _root_ide_package_.io.github.kotlinmania.llama.core.halfToFloat(
                _root_ide_package_.io.github.kotlinmania.llama.core.floatToHalf(expectedF32)
            )
    ...
    fun testComputeMulF32() {
        ...
        val src0_1D = createAndInitTensor("src0_MulF32", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32, dims1D, currentOffset, fillSequence = true, startValue = 1.5f, step = 1.0f)
        currentOffset += size1D
        val src1_1D = createAndInitTensor("src1_MulF32", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32, dims1D, currentOffset, fillSequence = true, startValue = 2.0f, step = 0.5f)
        ...
        val resultMul1D = runBinaryOp(src0_1D, src1_1D, "mul_f16_dst") { dst ->
            _root_ide_package_.io.github.kotlinmania.llama.core.computeMul(graphAllocator, src0_1D, src1_1D, dst)
        }
        for (i in 0 until dims1D[0].toInt()) {
    ...
    fun testComputeMulF16() {
        ...
        val src0_1D = createAndInitTensor("src0_MulF16", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F16, dims1D, currentOffset)
        currentOffset += size1D
        val src1_1D = createAndInitTensor("src1_MulF16", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F16, dims1D, currentOffset)
    ...
    fun testComputeMatMulF32xSF32() {
        ...
        val src0Data = floatArrayOf(1f, 2f, 3f,  // Row 0
                                    4f, 5f, 6f)  // Row 1
        val src0 = createAndInitTensor("src0_MM_F32", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32, longArrayOf(K0.toLong(), M0.toLong()), currentOffset)
        currentOffset += calculateTensorByteSize(_root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32, src0.ne)
        for (r in 0 until M0) {
            for (c in 0 until K0) {
        ...
        val src1Data = floatArrayOf(7f, 8f,    // Row 0
                                    9f, 10f,   // Row 1
                                    11f, 12f)  // Row 2
        val src1 = createAndInitTensor("src1_MM_F32", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32, longArrayOf(N1.toLong(), K1.toLong()), currentOffset)
        ...
        val resultTensor = allocateTensor("matmul_f32_dst", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32, longArrayOf(N1.toLong(), M0.toLong()))
        _root_ide_package_.io.github.kotlinmania.llama.core.computeMatMul(graphAllocator, src0, src1, resultTensor)

        assertEquals(_root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32, resultTensor.type, "Result type should be F32")
    ...
    fun testComputeMatMulQ80xSF32() {
        ...
        val M0 = 2
        val K0 = _root_ide_package_.io.github.kotlinmania.llama.core.QK8_0
        val N1 = 2
        ...
        val tempF32Src0 = createAndInitTensor("tempF32Src0", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32, longArrayOf(K0.toLong(), M0.toLong()), currentOffset)
        currentOffset += calculateTensorByteSize(_root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32, tempF32Src0.ne)
        for (r in 0 until M0) {
            for (c in 0 until K0) {
                tempF32Src0.setFloat(graphAllocator, src0F32Data[r * K0 + c], c, r)
            }
        }
        val q8Quantized = _root_ide_package_.io.github.kotlinmania.llama.core.quantizeTensor(
            graphAllocator,
            tempF32Src0,
            _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.Q8_0
        )
        assertEquals(_root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.Q8_0, q8Quantized.type)
        ...
        val blockStrideBytes = SHORT_SIZE_BYTES + _root_ide_package_.io.github.kotlinmania.llama.core.QK8_0
        val firstScale = _root_ide_package_.io.github.kotlinmania.llama.core.halfToFloat(q8RawData.getShortLe(0))
        val secondScale =
            _root_ide_package_.io.github.kotlinmania.llama.core.halfToFloat(q8RawData.getShortLe(blockStrideBytes))
        ...
        val q8Src0 = allocateTensor("q8_src0", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.Q8_0, longArrayOf(K0.toLong(), M0.toLong()))
        ...
        val q8Dequant = _root_ide_package_.io.github.kotlinmania.llama.core.dequantizeTensor(graphAllocator, q8Src0)
        ...
        val src1F32 = createAndInitTensor("src1_MM_F32", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32, longArrayOf(N1.toLong(), K0.toLong()), currentOffset)
        for (r in 0 until K0) {
            for (c in 0 until N1) {
        ...
        val resultTensor = allocateTensor("matmul_q8_f32_dst", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32, longArrayOf(N1.toLong(), M0.toLong()))
        _root_ide_package_.io.github.kotlinmania.llama.core.computeMatMul(graphAllocator, q8Src0, src1F32, resultTensor)

        assertEquals(_root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32, resultTensor.type, "Result type should be F32 for Q8_0 x F32")
        assertEquals(N1.toLong(), resultTensor.ne[0], "Result cols (ne[0]) mismatch")
        assertEquals(M0.toLong(), resultTensor.ne[1], "Result rows (ne[1]) mismatch")
    ...
    fun testComputeRepeatBackF32BroadcastFirstDim() {
        ...
        val src = createAndInitTensor("repeat_back_src", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32, srcNe, currentOffset)
        ...
        currentOffset += calculateTensorByteSize(_root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32, srcNe)
        val dstNe = longArrayOf(1, 3)
        val dst = createAndInitTensor("repeat_back_dst", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32, dstNe, currentOffset)

        _root_ide_package_.io.github.kotlinmania.llama.core.computeRepeatBack(graphAllocator, src, dst)
    ...
    internal fun getTensorDataAsFloatArray(tensor: io.github.kotlinmania.llama.core.GGMLTensor, graphAllocator: io.github.kotlinmania.llama.core.GGMLGraphAllocator): FloatArray {
        ...
        if (tensor.type == _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F16 && tensor.data is ShortArray) {
            val sa = tensor.data as ShortArray
            if (sa.size == numElements) {
                return FloatArray(numElements) { i -> _root_ide_package_.io.github.kotlinmania.llama.core.halfToFloat(sa[i]) }
            }
        }
        ...
        if (tensor.bufferId != -1) {
            ...
            _root_ide_package_.io.github.kotlinmania.llama.core.applyNDIter(tensor, numElements) { _, indices ->
                if (idx < numElements) {
                    floatArray[idx++] = when (tensor.type) {
                        _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32 -> tensor.getFloat(
                            graphAllocator,
                            *indices
                        )

                        _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F16 -> tensor.getHalf(
                            graphAllocator,
                            *indices
                        )
    ...
    fun testComputeReluF32() {
        ...
        val srcTensor = createAndInitTensor("relu_f32_src", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32, srcNe, dataOffset = 0uL)
        for(i in srcData.indices) srcTensor.setFloat(graphAllocator, srcData[i], i)


        val resultTensor = runUnaryOp(srcTensor, "relu_dst") { dst ->
            _root_ide_package_.io.github.kotlinmania.llama.core.computeRelu(graphAllocator, srcTensor, dst)
        }

        assertEquals(_root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32, resultTensor.type)
    ...
    fun testComputeReluF16() {
        ...
        val srcTensor = createAndInitTensor("relu_f16_src", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F16, srcNe, dataOffset = 0uL)
        ...
        assertEquals(_root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F16, resultTensor.type)
        ...
        for(i in expectedDataF32.indices) {
            assertEquals(
                _root_ide_package_.io.github.kotlinmania.llama.core.halfToFloat(
                    _root_ide_package_.io.github.kotlinmania.llama.core.floatToHalf(
                        expectedDataF32[i]
                    )
    ...
    fun testComputeGeluF32() {
        ...
        val srcTensor = createAndInitTensor("gelu_f32_src", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32, srcNe, dataOffset = 0uL)
        for(i in srcData.indices) srcTensor.setFloat(graphAllocator, srcData[i], i)

        val resultTensor = runUnaryOp(srcTensor, "gelu_dst") { dst ->
            _root_ide_package_.io.github.kotlinmania.llama.core.computeGelu(graphAllocator, srcTensor, dst)
        }
    ...
    fun testComputeGeluF16() {
        ...
        val srcTensor = createAndInitTensor("gelu_f16_src", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F16, srcNe, dataOffset = 0uL)
        for(i in srcDataF32.indices) srcTensor.setHalf(graphAllocator, srcDataF32[i], i)
    ...
    fun testComputeSiluF32() {
        ...
        val srcTensor = createAndInitTensor("silu_f32_src", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32, srcNe, dataOffset = 0uL)
        for(i in srcData.indices) srcTensor.setFloat(graphAllocator, srcData[i], i)
        ...
        val resultTensor = runUnaryOp(srcTensor, "silu_dst") { dst ->
            _root_ide_package_.io.github.kotlinmania.llama.core.computeSilu(graphAllocator, srcTensor, dst)
        }
    ...
    fun testComputeSiluF16() {
        ...
        val srcTensor = createAndInitTensor("silu_f16_src", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F16, srcNe, dataOffset = 0uL)
        for(i in srcDataF32.indices) srcTensor.setHalf(graphAllocator, srcDataF32[i], i)
    ...
    fun testComputeSoftMaxF32() {
        ...
        val srcTensor = createAndInitTensor("softmax_f32_src", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32, srcNe, dataOffset = 0uL)
        for (i in srcData.indices) srcTensor.setFloat(graphAllocator, srcData[i], i)

        val resultTensor = runUnaryOp(srcTensor, "softmax_dst") { dst ->
            _root_ide_package_.io.github.kotlinmania.llama.core.computeSoftMax(graphAllocator, srcTensor, dst)
        }
    ...
    fun testComputeSoftMaxF16() {
        ...
        val srcTensor = createAndInitTensor("softmax_f16_src", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F16, srcNe, dataOffset = 0uL)
        for (i in srcDataF32.indices) srcTensor.setHalf(graphAllocator, srcDataF32[i], i)
    ...
    fun testComputeRMSNormF32() {
        ...
        // Using createAndInitTensor and then populating for consistency
        val srcTensor = createAndInitTensor("rms_f32_src", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32, srcNe, dataOffset = 0uL)
        for(i in srcData.indices) srcTensor.setFloat(graphAllocator, srcData[i], i)

        val eps = 1e-5f

        val resultTensor = runUnaryOp(srcTensor, "rms_f32_dst") { dst ->
            _root_ide_package_.io.github.kotlinmania.llama.core.computeRMSNorm(graphAllocator, srcTensor, eps, dst)
        }
    ...
    fun testComputeRMSNormF16() {
        ...
        val srcTensor = createAndInitTensor("rms_f16_src", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F16, srcNe, dataOffset = currentOffset)
        for(i in srcDataF32.indices) srcTensor.setHalf(graphAllocator, srcDataF32[i], i)
    ...
    fun testComputeAddI32() {
        ...
        val src0 = createAndInitTensor("add_i32_src0", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I32, srcNe, dataOffset = currentOffset)
        for(i in src0Data.indices) src0.setInt(graphAllocator, src0Data[i], i)
        currentOffset += calculateTensorByteSize(_root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I32, srcNe)

        val src1 = createAndInitTensor("add_i32_src1", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I32, srcNe, dataOffset = currentOffset)
        ...
        assertEquals(_root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I32, resultTensor.type)
    ...
    fun testComputeAddI16() {
        ...
        val src0 = createAndInitTensor("add_i16_src0", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I16, srcNe, dataOffset = currentOffset)
        for(i in src0Data.indices) src0.setShort(graphAllocator, src0Data[i], i)
        currentOffset += calculateTensorByteSize(_root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I16, srcNe)

        val src1 = createAndInitTensor("add_i16_src1", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I16, srcNe, dataOffset = currentOffset)
        ...
        assertEquals(_root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I16, resultTensor.type)
        assertTrue(src0.ne.contentEquals(resultTensor.ne))
    ...
    fun testComputeAddI8() {
        ...
        val src0 = createAndInitTensor("add_i8_src0", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I8, srcNe, dataOffset = currentOffset)
        for(i in src0Data.indices) src0.setByte(graphAllocator, src0Data[i], i)
        currentOffset += calculateTensorByteSize(_root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I8, srcNe)

        val src1 = createAndInitTensor("add_i8_src1", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I8, srcNe, dataOffset = currentOffset)
        for(i in src1Data.indices) src1.setByte(graphAllocator, src1Data[i], i)

        val resultTensor = runBinaryOp(src0, src1, "add_i8_dst") { dst ->
            _root_ide_package_.io.github.kotlinmania.llama.core.computeAdd(graphAllocator, src0, src1, dst)
        }
        assertEquals(_root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I8, resultTensor.type)
        assertTrue(src0.ne.contentEquals(resultTensor.ne))
    ...
    fun testComputeAddI64() {
        ...
        val src0 = createAndInitTensor("add_i64_src0", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I64, srcNe, dataOffset = currentOffset)
        for(i in src0Data.indices) src0.setLong(graphAllocator, src0Data[i], i)
        currentOffset += calculateTensorByteSize(_root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I64, srcNe)

        val src1 = createAndInitTensor("add_i64_src1", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I64, srcNe, dataOffset = currentOffset)
        for(i in src1Data.indices) src1.setLong(graphAllocator, src1Data[i], i)

        val resultTensor = runBinaryOp(src0, src1, "add_i64_dst") { dst ->
            _root_ide_package_.io.github.kotlinmania.llama.core.computeAdd(graphAllocator, src0, src1, dst)
        }
        assertEquals(_root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I64, resultTensor.type)
        assertTrue(src0.ne.contentEquals(resultTensor.ne))
    ...
    fun testComputeMulI32() {
        ...
        val src0 = createAndInitTensor("mul_i32_src0", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I32, srcNe, dataOffset = currentOffset)
        for(i in src0Data.indices) src0.setInt(graphAllocator, src0Data[i], i)
        currentOffset += calculateTensorByteSize(_root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I32, srcNe)

        val src1 = createAndInitTensor("mul_i32_src1", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I32, srcNe, dataOffset = currentOffset)
        for(i in src1Data.indices) src1.setInt(graphAllocator, src1Data[i], i)
    ...
    fun testComputeMulI16() {
        ...
        val src0 = createAndInitTensor("mul_i16_src0", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I16, srcNe, dataOffset = currentOffset)
        for(i in src0Data.indices) src0.setShort(graphAllocator, src0Data[i], i)
        currentOffset += calculateTensorByteSize(_root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I16, srcNe)

        val src1 = createAndInitTensor("mul_i16_src1", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I16, srcNe, dataOffset = currentOffset)
        for(i in src1Data.indices) src1.setShort(graphAllocator, src1Data[i], i)
    ...
    fun testComputeMulI8() {
        ...
        val src0 = createAndInitTensor("mul_i8_src0", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I8, srcNe, dataOffset = currentOffset)
        for(i in src0Data.indices) src0.setByte(graphAllocator, src0Data[i], i)
        currentOffset += calculateTensorByteSize(_root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I8, srcNe)

        val src1 = createAndInitTensor("mul_i8_src1", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I8, srcNe, dataOffset = currentOffset)
        for(i in src1Data.indices) src1.setByte(graphAllocator, src1Data[i], i)
    ...
    fun testComputeMulI64() {
        ...
        val src0 = createAndInitTensor("mul_i64_src0", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I64, srcNe, dataOffset = currentOffset)
        for(i in src0Data.indices) src0.setLong(graphAllocator, src0Data[i], i)
        currentOffset += calculateTensorByteSize(_root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I64, srcNe)

        val src1 = createAndInitTensor("mul_i64_src1", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I64, srcNe, dataOffset = currentOffset)
        for(i in src1Data.indices) src1.setLong(graphAllocator, src1Data[i], i)
    ...
    fun testComputeSubI32() {
        ...
        val src0 = createAndInitTensor("sub_i32_src0", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I32, srcNe, dataOffset = currentOffset)
        for(i in src0Data.indices) src0.setInt(graphAllocator, src0Data[i], i)
        currentOffset += calculateTensorByteSize(_root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I32, srcNe)

        val src1 = createAndInitTensor("sub_i32_src1", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I32, srcNe, dataOffset = currentOffset)
        for(i in src1Data.indices) src1.setInt(graphAllocator, src1Data[i], i)
    ...
    fun testComputeSubI16() {
        ...
        val src0 = createAndInitTensor("sub_i16_src0", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I16, srcNe, dataOffset = currentOffset)
        for(i in src0Data.indices) src0.setShort(graphAllocator, src0Data[i], i)
        currentOffset += calculateTensorByteSize(_root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I16, srcNe)

        val src1 = createAndInitTensor("sub_i16_src1", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I16, srcNe, dataOffset = currentOffset)
        for(i in src1Data.indices) src1.setShort(graphAllocator, src1Data[i], i)
    ...
    fun testComputeSubI8() {
        ...
        val src0 = createAndInitTensor("sub_i8_src0", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I8, srcNe, dataOffset = currentOffset)
        for(i in src0Data.indices) src0.setByte(graphAllocator, src0Data[i], i)
        currentOffset += calculateTensorByteSize(_root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I8, srcNe)

        val src1 = createAndInitTensor("sub_i8_src1", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I8, srcNe, dataOffset = currentOffset)
        for(i in src1Data.indices) src1.setByte(graphAllocator, src1Data[i], i)
    ...
    fun testComputeSubI64() {
        ...
        val src0 = createAndInitTensor("sub_i64_src0", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I64, srcNe, dataOffset = currentOffset)
        for(i in src0Data.indices) src0.setLong(graphAllocator, src0Data[i], i)
        currentOffset += calculateTensorByteSize(_root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I64, srcNe)

        val src1 = createAndInitTensor("sub_i64_src1", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I64, srcNe, dataOffset = currentOffset)
        for(i in src1Data.indices) src1.setLong(graphAllocator, src1Data[i], i)
    ...
    fun testComputeDivI32() {
        ...
        val src0 = createAndInitTensor("div_i32_src0", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I32, srcNe, dataOffset = currentOffset)
        for(i in src0Data.indices) src0.setInt(graphAllocator, src0Data[i], i)
        currentOffset += calculateTensorByteSize(_root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I32, srcNe)

        val src1 = createAndInitTensor("div_i32_src1", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I32, srcNe, dataOffset = currentOffset)
        for(i in src1Data.indices) src1.setInt(graphAllocator, src1Data[i], i)
        currentOffset += calculateTensorByteSize(_root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I32, srcNe)
        ...
        val src1DivByZero = createAndInitTensor("div_i32_src1_div_zero", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I32, srcNe, dataOffset = currentOffset)
        ...
        assertFailsWith<ArithmeticException>("DIV I32 by zero should throw ArithmeticException") {
            ...
            _root_ide_package_.io.github.kotlinmania.llama.core.computeDiv(graphAllocator, src0, src1DivByZero, dst)
        }
    }
    ...
    fun testComputeDivI16() {
        ...
        val src0 = createAndInitTensor("div_i16_src0", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I16, srcNe, dataOffset = currentOffset)
        for(i in src0Data.indices) src0.setShort(graphAllocator, src0Data[i], i)
        currentOffset += calculateTensorByteSize(_root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I16, srcNe)

        val src1 = createAndInitTensor("div_i16_src1", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I16, srcNe, dataOffset = currentOffset)
        for(i in src1Data.indices) src1.setShort(graphAllocator, src1Data[i], i)
        currentOffset += calculateTensorByteSize(_root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I16, srcNe)
        ...
        val src1DivByZero = createAndInitTensor("div_i16_src1_div_zero", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I16, srcNe, dataOffset = currentOffset)
    ...
    fun testComputeDivI8() {
        ...
        val src0 = createAndInitTensor("div_i8_src0", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I8, srcNe, dataOffset = currentOffset)
        for(i in src0Data.indices) src0.setByte(graphAllocator, src0Data[i], i)
        currentOffset += calculateTensorByteSize(_root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I8, srcNe)

        val src1 = createAndInitTensor("div_i8_src1", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I8, srcNe, dataOffset = currentOffset)
        for(i in src1Data.indices) src1.setByte(graphAllocator, src1Data[i], i)
        currentOffset += calculateTensorByteSize(_root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I8, srcNe)
        ...
        val src1DivByZero = createAndInitTensor("div_i8_src1_div_zero", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I8, srcNe, dataOffset = currentOffset)
    ...
    fun testComputeDivI64() {
        ...
        val src0 = createAndInitTensor("div_i64_src0", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I64, srcNe, dataOffset = currentOffset)
        for(i in src0Data.indices) src0.setLong(graphAllocator, src0Data[i], i)
        currentOffset += calculateTensorByteSize(_root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I64, srcNe)

        val src1 = createAndInitTensor("div_i64_src1", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I64, srcNe, dataOffset = currentOffset)
        for(i in src1Data.indices) src1.setLong(graphAllocator, src1Data[i], i)
        currentOffset += calculateTensorByteSize(_root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I64, srcNe)
        ...
        val src1DivByZero = createAndInitTensor("div_i64_src1_div_zero", _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.I64, srcNe, dataOffset = currentOffset)
