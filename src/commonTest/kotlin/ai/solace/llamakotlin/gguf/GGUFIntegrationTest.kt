...
class GGUFIntegrationTest {
    ...
    fun testCompleteModelLoadingWorkflow() {
        ...
        assertTrue(tensor0.type == _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32)
        ...
        assertTrue(tensor1.type == _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32)
    ...
    fun testTensorMetadataExtraction() {
        ...
        assertTrue(tensor0Info.type == _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32)
        ...
        assertTrue(tensor1Info.type == _root_ide_package_.io.github.kotlinmania.llama.core.GGMLType.F32)
