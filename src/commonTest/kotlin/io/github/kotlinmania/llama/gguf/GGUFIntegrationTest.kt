...
class GGUFIntegrationTest {
    ...
    fun testCompleteModelLoadingWorkflow() {
        ...
        assertTrue(tensor0.type == io.github.kotlinmania.llama.ore.GGMLType.F32)
        ...
        assertTrue(tensor1.type == io.github.kotlinmania.llama.ore.GGMLType.F32)
    ...
    fun testTensorMetadataExtraction() {
        ...
        assertTrue(tensor0Info.type == io.github.kotlinmania.llama.ore.GGMLType.F32)
        ...
        assertTrue(tensor1Info.type == io.github.kotlinmania.llama.ore.GGMLType.F32)
