...
- Backlog files live in `docs/backlog/.../*_FUTURE_issues-<ids>.md` and capture aspirational work tied to GitHub issues.
...
- Backlog
  - [Overview — issues 107, 117](docs/backlog/arena/stackless_runtime/OVERVIEW_FUTURE_issues-107-117.md)
  - [Continuation Guide — issue 114](docs/backlog/arena/stackless_runtime/CONTINUATION_GUIDE_FUTURE_issues-114.md)
  - [Continuation Model — issues 107, 117](docs/backlog/arena/stackless_runtime/CONTINUATION_MODEL_FUTURE_issues-107-117.md)
  - [Scheduler — issues 108, 113](docs/backlog/arena/stackless_runtime/SCHEDULER_FUTURE_issues-108-113.md)
...
- Backlog
  - [Overview — issues 109, 112, 116](docs/backlog/arena/token_kernel/OVERVIEW_FUTURE_issues-109-112-116.md)
  - [Implementation — issues 109, 112](docs/backlog/arena/token_kernel/IMPLEMENTATION_FUTURE_issues-109-112.md)
  - [Flow Analysis — issue 111](docs/backlog/arena/token_kernel/TOKEN_FLOW_ANALYSIS_FUTURE_issues-111.md)

**Arena / Channels**
- Verified
  - [Design](external/kcoro_arena/docs/components/channels/CHANNEL_DESIGN_VERIFIED.md)
- Backlog
  - [Design — issue 115](docs/backlog/arena/channels/CHANNEL_DESIGN_FUTURE_issues-115.md)

**Arena / Descriptors**
- Verified
  - [Reference Counting](external/kcoro_arena/docs/components/descriptors/DESCRIPTOR_REFCOUNTING_VERIFIED.md)
- Backlog
  - [Reference Counting — issues 110, 116](docs/backlog/arena/descriptors/DESCRIPTOR_REFCOUNTING_FUTURE_issues-110-116.md)

**Legacy kcoro / Core**
- Verified
  - [Core](external/kcoro/docs/components/core/CORE_VERIFIED.md)
- Backlog
  - [Core — issue 118](docs/backlog/kcoro/core/CORE_FUTURE_issues-118.md)
