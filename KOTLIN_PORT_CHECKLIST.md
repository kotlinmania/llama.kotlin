...
- [x] Design Kotlin Native Architecture
  - [x] Design package structure (io.github.kotlinmania.llama.llamakotlin.*)
...
- [ ] **BLOCKED**: Fix package naming inconsistencies
  - llama.kotlin imports `io.github.kotlinmania.llama.klang.*`
  - Vendored klang has mixed `io.github.kotlinmania.llama.klang.*` and `io.github.kotlinmania.llama.klang.*`
- [ ] **BLOCKED**: Remove duplicate klang sources
  - Removed from `src/commonMain/kotlin/io.github.kotlinmania.llama.klang/` (December 2025)
...
- [x] KLang namespace and modules
  - [x] `io.github.kotlinmania.llama.klang.fp`: `CFloat32` (inline) with operators +, −, ×, ÷ delegating to bit‑exact soft‑float
  - [x] `io.github.kotlinmania.llama.klang.bitwise.Float32Math`: transliterations of compiler‑rt float32 builtins
...
- [x] 16‑bit limb engine for exact 128‑bit intermediates
  - [x] `io.github.kotlinmania.llama.klang.int.hpc.HPC16x4` (64‑bit, 4×16‑bit limbs): add/sub/compare/shifts
  - [x] `io.github.kotlinmania.llama.klang.int.hpc.HPC16x8` (128‑bit, 8×16‑bit limbs): add/sub/compare/shifts, initial 64×64→128 mul
